...
async function createVisit(req, res) {
  try {
    const { name, email, phone, studentId, school, floor, date, time, timeOfDay, purpose, purposeDetail, contact } = req.body;
    ...
    console.log('Form luôn mở, tiếp tục xử lý đăng ký');
